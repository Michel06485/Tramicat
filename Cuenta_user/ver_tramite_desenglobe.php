...
$sql = "SELECT tipo_solicitante, nombres_apellidos, tipo_documento, numero_documento, correo, telefono, ciudad_municipio, matricula_inmobiliaria, numero_predial, archivo1, archivo2, archivo3, archivo4, descripcion, estado, respuesta
...
<header>
    ...
    <main class="main" id="mainContent">
        ...
        <fieldset>
                ...
                <div class="form-group">
                <span class="data-span"><?php echo $solicitud['descripcion'];?></span>
                </div>
            </fieldset>
        </div>
