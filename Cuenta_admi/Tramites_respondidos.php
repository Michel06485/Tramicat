...
$sql = "SELECT f.id, u.nombre, u.apellido, f.tipo_tramite, f.id, f.estado, f.fecha
...
<main id="mainContent" class="main">
        ...
        <section id="tramites">
            <div class="btns-tramites">
                <a href="/prueba22/Cuenta_admi/Tramites_admi.php" class="btn-tra1">Tamites sin responder</a>
                <a href="/prueba22/Cuenta_admi/Tramites_respondidos.php" class="btn-tra1 active1">Tamites respondidos</a>
            </div>
    
            <div class="container">
                <div class="filtro">
                    <h2>Solicitud de trámites respondidos</h2>
                    <div class="buscador">
