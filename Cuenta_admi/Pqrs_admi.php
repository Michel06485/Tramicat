...
$sql = "SELECT p.id, u.nombre, u.apellido, p.tipo_pqrs, p.estado, p.fecha_solicitud
...
<div class="menu-lateral mobile-hidden" id="menuLateral">
    ...
    <main class="main" id="mainContent">
        ...
        <a href="Pqrs_admi.php" class="btn-tra1 active1">PQRS sin responder</a>
        <a href="/prueba22/Cuenta_admi/Pqrs_respondidos_admi.php" class="btn-tra1 " >PQRS respondidos</a>
</div>
    
            <div class="container">
                <div class="filtro">
                    <h2>Solicitud de PQRS recibidas</h2>
                    <div class="buscador">
