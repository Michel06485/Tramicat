...
$sql = "SELECT f.id, u.nombre, u.apellido, u.email, u.tip_doc, u.num_doc, f.tipo_solicitante, f.nombres_apellidos,f.tipo_documento, f.numero_documento, f.correo, f.telefono, f.ciudad_municipio, f.matricula_inmobiliaria, f.numero_predial, f.archivo1, f.archivo2, f.archivo3, f.archivo4, f.descripcion,  f.estado, f.fecha, f.respuesta
...
<div class="menu-lateral mobile-hidden" id="menuLateral">
    ...
    <section class="container">
        ...
        <div class="container">
            <div class="titulo-cuenta">
                <h2>Formulario de Desenglobe</h2>
            </div>
            ...
            <div class="file-input-container">
                ...
                <p><a href="/prueba22/uploads/desenglobe/<?php echo basename($solicitud['archivo1']); ?>" target="_blank">Ver Archivo</a></p>
            </div>
            <div class="file-input-container">
                <div class="file-text">2. Plano topográfico adicional:</div>
                <p><a href="/prueba22/uploads/desenglobe/<?php echo basename($solicitud['archivo2']); ?>" target="_blank">Ver Archivo</a></p>
            </div>
            <div class="file-input-container">
                <div class="file-text">3. Referencia o copia simple de la licencia de construcción que aprueba la partición:</div>
                <p><a href="/prueba22/uploads/desenglobe/<?php echo basename($solicitud['archivo3']); ?>" target="_blank">Ver Archivo</a></p>
            </div>
            <div class="file-input-container">
                <div class="file-text">4. Archivo que contenga la relación de unidades prediales a desenglobar:</div>
                <p><a href="/prueba22/uploads/desenglobe/<?php echo basename($solicitud['archivo4']); ?>" target="_blank">Ver Archivo</a></p>
            </div>
        </fieldset>
        <fieldset>
