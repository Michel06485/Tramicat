...
$uploads_dir = 'C:/laragon/www/prueba22/uploads/cambio_propietario';
    ...
    if (!empty($_FILES['archivo1']['name']) && !empty($_FILES['archivo2']['name']) && !empty($_FILES['archivo3']['name'])) {
        ...
        if (move_uploaded_file($_FILES['archivo1']['tmp_name'], $archivo1) &&
            ...
            $sql = "INSERT INTO formulario_tramites (id_usuario, tipo_solicitante, nombres_apellidos, tipo_documento, numero_documento, correo, telefono, ciudad_municipio, matricula_inmobiliaria, numero_predial, archivo1, archivo2, archivo3, descripcion, tipo_tramite, estado, numero_radicado)
                    VALUES ('$id_usuario', '$tipo_solicitante', '$nombres_apellidos', '$tipo_documento', '$numero_documento', '$correo', '$telefono', '$ciudad_municipio', '$matricula_inmobiliaria', '$numero_predial', '$archivo1', '$archivo2', '$archivo3', '$descripcion', 'Cambio de Propietario', 'pendiente', '$numero_radicado')";
            ...
            if ($conexion->query($sql) === TRUE) {
                ...
                <div class="container_editar" id="container_editar">
                    ...
                    <h1 class="text1">Confirmación de Solicitud de Cambio de Propietario</h1>

                    <div class="container">
                        <p>Estimado usuario, Le informamos que su solicitud de cambio de propietario ha sido enviada correctamente. Recibirá una notificación por correo electrónico a la dirección <b>' . htmlspecialchars($correo) . '</b> una vez que su solicitud haya sido procesada.</p>
...
<head>
    ...
    <title>Formulario de cambio de propietario</title>
...
<form action="" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
        <h1>Formulario de Cambio de Propietario</h1>
    ...
    <script src="/assets/JavaScript/formularios.js"></script>
</main>
</body>
</html>
