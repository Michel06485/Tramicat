...
$uploads_dir = 'C:/laragon/www/prueba22/uploads/desenglobe';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_FILES['archivo1']['name']) && !empty($_FILES['archivo2']['name']) && !empty($_FILES['archivo3']['name']) && !empty($_FILES['archivo4']['name'])) {
        ...
        $archivo4 = $uploads_dir . '/' . basename($_FILES['archivo4']['name']);

        // Validar y mover los archivos cargados
        if (move_uploaded_file($_FILES['archivo1']['tmp_name'], $archivo1) &&
            ...
            $sql = "INSERT INTO formulario_tramites (id_usuario, tipo_solicitante, nombres_apellidos, tipo_documento, numero_documento, correo, telefono, ciudad_municipio, matricula_inmobiliaria, numero_predial, archivo1, archivo2, archivo3, archivo4, descripcion, tipo_tramite, estado, numero_radicado)
                    VALUES ('$id_usuario', '$tipo_solicitante', '$nombres_apellidos', '$tipo_documento', '$numero_documento', '$correo', '$telefono', '$ciudad_municipio', '$matricula_inmobiliaria', '$numero_predial', '$archivo1', '$archivo2', '$archivo3', '$archivo4', '$descripcion', 'Desenglobe', 'pendiente', '$numero_radicado')";
            ...
            if ($conexion->query($sql) === TRUE) {
                ...
                <div class="editar_perfil" id="editar_perfil">
                    <div class="container_editar" id="container_editar">
                        ...
                        <h1 class="text1">Confirmación de Solicitud de Desenglobe</h1>
                        <div class="container">
                            <p>Estimado usuario, Le informamos que su solicitud de desenglobe ha sido enviada correctamente. Recibirá una notificación por correo electrónico a la dirección <b>' . htmlspecialchars($correo) . '</b> una vez que su solicitud haya sido procesada.</p>
            ...
            .close { animation: closeModal 1s forwards cubic-bezier(0, -0.42, 1, -0.41); }
        ...
        echo "Todos los archivos son obligatorios.";
    }
}
?>
...
<head>
    ...
    <title>Formulario de desenglobe</title>
...
<main class="container formulario">
    <form action="" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
        <h1>Formulario de Desenblobe</h1>
        ...
        <fieldset>
            ...
            <!-- Requisito 2 -->
            <div class="file-input-container">
                <div class="file-text">2. Plano topográfico adicional:</div>
                <div class="file-preview">
            ...
            <!-- Requisito 4 -->
            <div class="file-input-container">
                <div class="file-text">4. Archivo que contenga la relación de unidades prediales a desenglobar:</div>
                <div class="file-preview">
                    <input type="file" id="archivo4" name="archivo4" accept=".pdf" required onchange="this.nextElementSibling.textContent = this.files[0].name">
                    <label for="archivo4" class="file-label">
                        <i class='bx bx-file-blank file-icon'></i>
                        <span class="file-name">No hay archivo seleccionado</span>
                    </label>
                </div>
